...
class ObjectMerger(Node):
    def __init__(self):
        ...
        self.objects0 = Subscriber(self, DetectedObjects, '/perception/object_recognition/detection/centerpoint/objects')
        self.objects1 = Subscriber(self, DetectedObjects, '/perception/object_recognition/prediction/point/carom/objects')
        ...
        self.ts = ApproximateTimeSynchronizer([self.objects0, self.objects1], queue_size=10, slop=0.125) 
        # slop is the allowed time difference between different message topics for them to be considered synchronized.
        self.ts.registerCallback(self.object_merger_callback)
    ...
    def object_merger_callback(self, object0, object1):
